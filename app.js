...
let sessionOptions=session({
    ...
    cookie:{maxAge:1000 * 60 * 60 * 24,httpOnly}
})
...
app.use(function(req,res,next){
     //make mark down function availabel to all our fuctions
     res.locals.filterUserHTML=function(content){
        return sanitizeHTML(markdown(content),{allowedTags:['p','br','ul','ol','li','strong','bold','i','em','h1','h2','h3','h4','h5','h6'],
                                                allowedAttributes:{}})
     }
     
    //make all error and success flash msgs available to all ejs templates
